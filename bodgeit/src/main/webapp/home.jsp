...
<%
	...
	try {
		...
		rs.close();
		stmt.close();
		out.println("<center><table id=\"products\" border=\"1\" class=\"border\" width=\"80%\">");
		...
		for (int i=0; i < 10; i++) {
			...
			if (rs.next()) {
				...
				out.println("<td><a id=\"prodid_" + rs.getInt("productid") + "\"" +  "href=\"product.jsp?prodid=" + rs.getInt("productid") + "\">" + 
