...
if (request.getMethod().equals("POST") && username != null) {
	if (loggedIn) {
		...
		out.println("<p id=\"success\">You have logged in successfully: " + username + "</p>");
		return;

	} else {
		out.println("<p id=\"error\" style=\"color:red\">You supplied an invalid name or password.</p>");
...
If you dont have an account with us then please <a id="register" href="register.jsp">Register</a> now for a free account.
<br/><br/>
