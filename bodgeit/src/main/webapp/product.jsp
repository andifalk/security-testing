...
<%
	...
	try {
		...
		if (typeId != null) {
			...
			out.println("<center><table id=\"product\" class=\"border\" width=\"80%\">");
			...
			if (rs.next()) {
				...
				out.println("<td align=\"center\">&nbsp;<a id=\"decrease\" href=\"#\" onclick=\"decQuantity();\"><img src=\"images/130.png\" alt=\"Decrease quantity in basket\" border=\"0\"></a>&nbsp;<input id=\"quantity\" name=\"quantity\" value=\"1\" maxlength=\"2\" size = \"2\" style=\"text-align: right\" READONLY />&nbsp;<a id=\"increase\" href=\"#\" onclick=\"incQuantity();\"><img src=\"images/129.png\" alt=\"Increase quantity in basket\" border=\"0\"></a>&nbsp;");
