...
<%
	if (username != null) {
		out.println("User: <a id=\"password\" href=\"password.jsp\">" + username + "</a>");
	} else {
...
<tr>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="home" href="home.jsp">Home</a></td>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="about" href="about.jsp">About Us</a></td>
<%
	if (usertype != null && usertype.equals("ADMIN")) {
%>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="comments" href="contact.jsp">Comments</a></td>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="admin" href="admin.jsp">Admin</a></td>
<%
	} else {
%>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="contact" href="contact.jsp">Contact Us</a></td>
...
<%
	if (usertype == null || ! usertype.equals("ADMIN")) {
%>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="basket" href="basket.jsp">Your Basket</a></td>
<%
	}
%>
<td align="center" width="16%" BGCOLOR=#EEEEEE><a id="search" href="search.jsp">Search</a></td>
</tr>
<tr>
<td align="center" colspan="6">
