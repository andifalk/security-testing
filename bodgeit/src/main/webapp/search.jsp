...
<%              
                    ...
                    out.println("<div id=\"noresult\"><b>No Results Found</b></div>");
                }
        } catch (Exception e) {
		if ("true".equals(request.getParameter("debug"))) {
...
<table>
<tr><td>Search for</td><td><input id="searchInput" type='text' name='q'></td></td>
<tr><td></td><td><input id="submit" type='submit' value='Search'/></td></td>
<tr><td></td><td><a id="advancedSearch" href='advanced.jsp' style='font-size:9pt;'>Advanced Search</a></td></td>
</table>
</form>
<%  
}
