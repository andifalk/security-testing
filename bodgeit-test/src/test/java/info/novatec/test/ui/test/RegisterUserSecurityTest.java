...
public class RegisterUserSecurityTest extends RegisterUserTest {

	private static final Logger LOGGER = LoggerFactory.getLogger ( RegisterUserSecurityTest.class );
